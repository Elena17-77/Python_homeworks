...
def test_shop_form(chrome_browser):
    ...
    chrome_browser.find_element(By.ID, "first-name").send_keys("Elena")
    chrome_browser.find_element(By.ID, "last-name").send_keys("Mironova")
    chrome_browser.find_element(By.ID, "postal-code").send_keys("751520")
